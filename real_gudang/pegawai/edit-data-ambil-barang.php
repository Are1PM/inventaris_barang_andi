...
if (isset($_POST['Edit'])) {
	...
	if ($sql) {
		echo "<h3><font color=green><center><blink>Data Ambil Barang Berhasil diedit</blink></center></font></h3>
			<input type='button' value='Back To View' onclick=location.href='home_pegawai.php?page=lihat-data-ambil-barang' title='kembali ke form lihat data ambil barang'><br><br>";	
	} else {
     ...
     <form action="#" method="POST" name="postform">
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				?>
					<option value="<?= $hasil['id_pegawai'] ?>" <?= ($id_pegawai==$hasil['id_pegawai'])?"selected":""; ?>><?= $hasil['nama_pegawai'] ?></option>
				<?php 
					endwhile;
				?>
				</select>
			...
			<tr>
				...
				<td>
                    ...
                    <input type="button" value="Cancel"
                              onclick=location.href="home_pegawai.php?page=lihat-data-ambil-barang"
